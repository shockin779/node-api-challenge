...
- [x] Mention two parts of Express that you learned about this week.
    ...
    I learned about how express using middleware in order to allow you to do functions on different endpoints. I also learned that express simplifies the process of creating a server by using prebuilt functions

- [x] Describe Middleware?

    Middleware allows you to create your own custom functions to run when an endpoint path and method combination is made. The middelware allows you to do actions on the request / response and you can manipulate it.

- [x] Describe a Resource?

    A resource is usually a noun (i.e: user, post, etc) that you can manage with your api.

- [x] What can the API return to help clients know if a request was successful?

    You can return a status code to the client and some json.

- [x] How can we partition our application into sub-applications?

    We can use routers to seperate our main application into sub-applications.
